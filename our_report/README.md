...
2. **RESEARCH**
 ...
 <p>Right arrow: <i class="arrow right"></i></p>Τεχνολογίες που έχουν χρησιμοποιηθεί: 
   ...
   <p>Right arrow: <i class="arrow right"></i></p>Ανταγωνιστικά Προϊόντα:
       <ol>
...
<p>Right arrow: <i class="arrow right"></i></p> Τεχνολογίες που επρόκειτο να χρησμοποιήσομε:
